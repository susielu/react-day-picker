(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root['DayPicker'] = factory(root['React']);
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var ModifierPropType = (exports.ModifierPropType = _propTypes2.default.oneOfType(
          [
 ...
 */
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function Navbar(_ref) {
          ...
          var previousClickHandler = dir === 'rtl'
            ? onNextClick
            : onPreviousClick;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var WeekdayPropTypes = (exports.WeekdayPropTypes = {
          ...
          weekdaysShort: _PropTypes2.default.arrayOf(
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function getFirstDayOfWeekFromProps(props) {
          var firstDayOfWeek = props.firstDayOfWeek,
            ...
            localeUtils = _props$localeUtils === undefined
              ? {}
              : _props$localeUtils;
        ...
        function getModifiersForDay(d) {
          ...
          return Object.keys(modifiersObj).reduce(function(
            modifiers,
            modifier
          ) {
        ...
        function getWeekArray(d) {
          var firstDayOfWeek = arguments.length > 1 &&
            arguments[1] !== undefined
            ? arguments[1]
            : (0, _LocaleUtils.getFirstDayOfWeek)();
          ...
          for (var _i2 = lastWeek.length; _i2 < 7; _i2 += 1) {
            var _outsideDate = (0, _DateUtils.clone)(
 ...
 */
      ...
      /***/ function(module, exports, __webpack_require__) {
          ...
          _createClass(DayPicker, [
              ...
              value: function focusPreviousWeek(dayNode) {
                ...
                if (isInFirstWeekOfMonth) {
                  this.showPreviousMonth(function() {
                    ...
                    var startOfLastWeekOfMonth =
                      previousMonthDayNodes.length - 7;
            ...
            },
            {
              ...
              value: function renderDayInMonth(day, month) {
                ...
                var dayModifiers = Helpers.getModifiersForDay(
                  day,
                  propModifiers
                );
                if (
                ...
                return _react2.default.createElement(
                  _Day2.default,
                  {
                    ...
                    ariaDisabled: isOutside ||
                      dayModifiers.indexOf('disabled') > -1,
            ...
            },
            {
              ...
              value: function renderMonths() {
                var months = [];
                var firstDayOfWeek = Helpers.getFirstDayOfWeekFromProps(
                  this.props
                );
        ...
        DayPicker.defaultProps = {
          ...
          weekdayElement: _react2.default.createElement(
            _Weekday2.default,
            null
          ),
        ...
        var _initialiseProps = function _initialiseProps() {
          this.getStateFromProps = function(props) {
            var initialMonth = Helpers.startOfMonth(
            ...
            if (
              ...
              var diffInMonths = Helpers.getMonthsDiff(
                props.fromMonth,
                currentMonth
              );
              currentMonth = DateUtils.addMonths(
                props.fromMonth,
                Math.floor(diffInMonths / props.numberOfMonths) *
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var DayPicker = __webpack_require__(13);
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function Day(_ref) {
          ...
          var styles = Object.assign.apply(
            Object,
            [{}].concat(
              _toConsumableArray(
                Object.keys(modifiers).map(function(modifier) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _Weekdays = __webpack_require__(18);
        ...
        function Month(_ref) {
          ...
          var caption = _react2.default.isValidElement(captionElement)
            ? _react2.default.cloneElement(captionElement, captionProps)
            : _react2.default.createElement(captionElement, captionProps);

          var weeks = (0, _Helpers.getWeekArray)(
            month,
            firstDayOfWeek,
            fixedWeeks
          );
        ...
        Month.propTypes = {
          ...
          captionElement: _PropTypes2.default.oneOfType([
            _PropTypes2.default.element,
            _PropTypes2.default.func,
            _PropTypes2.default.instanceOf(_react2.default.Component),
          ]).isRequired,
          weekdayElement: _PropTypes2.default.oneOfType([
            _PropTypes2.default.element,
            _PropTypes2.default.func,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function Weekdays(_ref) {
          ...
          for (var i = 0; i < 7; i += 1) {
            ...
            var element = _react2.default.isValidElement(weekdayElement)
              ? _react2.default.cloneElement(weekdayElement, elementProps)
              : _react2.default.createElement(weekdayElement, elementProps);
            days.push(element);
          }
